...
function preload() {
	...
	game.load.image('contra2', 'js/assets/contra2.png');
	game.load.image('bunny', 'js/assets/bunny.png');
	game.load.image('tetrisblock1', 'js/assets/tetrisblock1.png');
	game.load.image('tetrisblock2', 'js/assets/tetrisblock2.png');
	game.load.image('tetrisblock3', 'js/assets/tetrisblock3.png');

	//	Load our physics data exported from PhysicsEditor
	game.load.physics('physicsData', 'js/assets/sprites.json');
