...
{    
    ...
    public:
        Object(const Object&& o): name(o.name), obj(nullptr), typeOfSprite(o.typeOfSprite), typeOfShape(o.typeOfShape), typeOfFixture(o.typeOfFixture) {}
        virtual ~Object(void) {}
    ...
    public:
        ...
        Object(void): name(""), obj(nullptr), typeOfSprite(entity::TypeOfSprite::SPRT_NONE), typeOfShape(entity::TypeOfShape::SHP_NONE), typeOfFixture(entity::TypeOfFixture::FIX_NONE) {}
        void CreateObject(std::string name, void* obj, entity::TypeOfSprite typeOfSprite, entity::TypeOfShape typeOfShape, entity::TypeOfFixture typeOfFixture)
        {
            this->name = name;
            this->obj = obj;
